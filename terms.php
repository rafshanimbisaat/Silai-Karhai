...
?>
    ...
    <section class="section" id="our-classes">
        <div class="container">
            <article>
                <ol class="list-group">
                    <li class="list-group-item"><h3><span class="font-weight-bold"><span>Our Terms And Conditions</span></h3></li>
                    ...
                    <li class="list-group-item"> <span class="font-weight-bold">2.</span> Silai Karhai is committed to provide the best quality of service to all our customers, however if you find an issue with fitting or quality of service then you can contact us on our website through contact us form within a week of delivering your order.</li>
                    ...
                    <li class="list-group-item"> <span class="font-weight-bold">5.</span> We only accept cash through cash on delivery payment method.</li>
